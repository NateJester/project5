...
_multithread:     file format elf32-i386
...
int main() {
  ...
  for (int i = 0; i < N_THREAD; i++) {
  1f:	83 c6 04             	add    $0x4,%esi
    stacks[i] = (char*)malloc(4096);
  22:	68 00 10 00 00       	push   $0x1000
  27:	e8 94 06 00 00       	call   6c0 <malloc>
  for (int i = 0; i < N_THREAD; i++) {
  2c:	83 c4 10             	add    $0x10,%esp
    stacks[i] = (char*)malloc(4096);
  2f:	89 46 fc             	mov    %eax,-0x4(%esi)
  for (int i = 0; i < N_THREAD; i++) {
  32:	39 f7                	cmp    %esi,%edi
  34:	75 e6                	jne    1c <main+0x1c>
  }
  ...
  3d:	05 00 10 00 00       	add    $0x1000,%eax
  42:	50                   	push   %eax
  43:	68 b0 00 00 00       	push   $0xb0
  48:	e8 76 03 00 00       	call   3c3 <clone>
    if (tid < 0) {
  4d:	83 c4 10             	add    $0x10,%esp
  50:	85 c0                	test   %eax,%eax
  52:	78 3c                	js     90 <main+0x90>
  for (int i = 0; i < N_THREAD; i++) {
  54:	83 c3 04             	add    $0x4,%ebx
  57:	39 fb                	cmp    %edi,%ebx
  59:	75 db                	jne    36 <main+0x36>
    }
  }
  ...
  {
    wait();
  5b:	e8 cb 02 00 00       	call   32b <wait>
  60:	e8 c6 02 00 00       	call   32b <wait>
  65:	e8 c1 02 00 00       	call   32b <wait>
  6a:	e8 bc 02 00 00       	call   32b <wait>
  }

  printf(1, "Final counter value: %d\n", global_counter);
  6f:	83 ec 04             	sub    $0x4,%esp
  72:	ff 35 10 0b 00 00    	push   0xb10
  78:	68 c4 07 00 00       	push   $0x7c4
  7d:	6a 01                	push   $0x1
  7f:	e8 0c 04 00 00       	call   490 <printf>

  exit();
  84:	e8 9a 02 00 00       	call   323 <exit>
...
void fn(void* arg) {
  ...
  b3:	83 ec 08             	sub    $0x8,%esp
    global_counter++;
  b6:	81 05 10 0b 00 00 a0 	addl   $0x186a0,0xb10
  bd:	86 01 00 
  exit();
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 e4 07 00 00 	jmp    *0x7e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba dd 07 00 00       	mov    $0x7dd,%edx
        while(*s != 0){
 ...
 631:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 14 0b 00 00    	mov    %edx,0xb14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 14 0b 00 00    	mov    0xb14,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 14 0b 00 00    	mov    %edx,0xb14
}
 ...
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 18 0b 00 00       	mov    $0xb18,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 18 0b 00 00 18 	movl   $0xb18,0xb18
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
