...
int main() {
  ...
  27:	e8 a4 06 00 00       	call   6d0 <malloc>
  for (int i = 0; i < N_THREAD; i++) {
  ...
  72:	ff 35 20 0b 00 00    	push   0xb20
  78:	68 d4 07 00 00       	push   $0x7d4
  7d:	6a 01                	push   $0x1
...
void fn(void* arg) {
  ...
  b3:	83 ec 08             	sub    $0x8,%esp
    global_counter++;
  b6:	81 05 20 0b 00 00 a0 	addl   $0x186a0,0xb20
  bd:	86 01 00 
  exit();
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 f4 07 00 00 	jmp    *0x7f4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba ed 07 00 00       	mov    $0x7ed,%edx
        while(*s != 0){
